  ...
  methods (Test)
    ...
    function testValidation(testCase)
      ...
      type_err = { ...
        ...
        , 'unclosed double quote with data on the following line' ...
        , 'unclosed multiline string' ...
                 };

      for indx = 1:numel(toml_str)
        testCase.verifyError(@() toml.decode(toml_str{indx}), ...
         expctd_err{indx}, ...
         ['Failed to reject invalid TOML data: ', type_err{indx}, '.'])
      end
    end
